				...
				<div>
					<table class="table table-hover table-bordered text-center">
						<tr>
							...
							<th class="col-md-1 text-center">신청 번호</th>
							...
							<th class="col-md-1 text-center">제휴 여부</th>
						</tr>

						<tr>
							<td>1</td>
							<td><a href="<c:url value='PartnersRequestView.do'/>">이바르게	치과</a></td>
							<td>홍길동</td>
							<td>010-1234-5678</td>
							<td>2018-09-24</td>
							<td>대기중</td>
