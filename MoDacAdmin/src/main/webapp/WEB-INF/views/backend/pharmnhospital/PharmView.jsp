...
<script>
	var isDelete = function(){
		...
		if(confirm("정말로 삭제하시겠습니까?")) {
			location.replace("<c:url value='PharmacyDelete.do?no=1'/>");
		}
	};
		        ...
		        <div class="table-responsive">
		          <table class="table table-hover">
		           <tr>
					...
					<tr>
						<th class="col-md-1 text-center">영업요일</th>
		...
		<div class="col-lg-12">
			<form class="form-inline">
				<div class="form-group">
					<a href="<c:url value='PharmacyEdit.do?no=1'/>" id="btnEdit" class="btn btn-primary"> 수정 </a>
				</div>
				<div class="form-group">
